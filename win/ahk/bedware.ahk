...
apps["gpt"] := { desktop: "Dev", selector: "ahk_exe ChatGPT.exe", path: "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\ChatGPT\ChatGPT.lnk" }
...
apps["music"] := { desktop: "Other", selector: "ahk_exe YandexMusic.exe", path: "C:\Users\dmitr\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\YandexMusic.lnk", postFunction: "makeAnyWindowMaximized" }
